...
* Use production shares for electronics manufacturing (too many exports using
* trade shares):

x0_(yr,r,'eec') = region_shr(yr,r,'eec') * x_0(yr,'eec');
x0_(yr,r,'cep') = region_shr(yr,r,'cep') * x_0(yr,'cep');
...
* determined by regional purchase coefficients (FAF).
